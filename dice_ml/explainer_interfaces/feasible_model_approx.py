        ...
        for epoch in range(self.epochs):
            ...
            for train_x in enumerate(train_dataset):
                ...
                if constraint_type:
                    ...
                    raise NotImplementedError("This has not been implemented yet. If you'dimensionality like this to be implemented in the next version, please raise an issue at https://github.com/interpretml/DiCE/issues")
