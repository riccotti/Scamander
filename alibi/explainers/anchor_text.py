...
class AnchorText(Explainer):
    ...
    def set_sampler_perturbation(self, use_unk: bool, perturb_opts: dict, top_n: int) -> None:
        ...
        perturb_opts
            A dict with keys:
                ...
                - 'sample_proba': given a feature and num_points sentences, this parameters is the mean of a Bernoulli \
    ...
    def find_similar_words(self) -> None:
        """
        This function queries a spaCy nlp model to find num_points similar words with the same
