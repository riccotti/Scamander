...
def main():
    ...
    filename_stability = path_results + 'instability_%s_%s_dice.csv' % (dataset, black_box)
    metric = 'none'
    ...
    experiment('dice', bb, bb_dice, X_train, variable_features, features_names, variable_cont_features_names,
               ...
               filename_stability, variable_features_flag, known_train, search_diversity, metric,
               backend, couples_to_test, exp_calc_dist)
