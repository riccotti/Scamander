...
def experiment(cfe, bb, X_train, variable_features, metric, continuous_features, categorical_features_lists,
               ...
               features_names, couples_to_test, exp_calc_dist):
    ...
    for test_id, couple in enumerate(couples_to_test):
        ...
        if variable_features_flag:
            ...
            exp1 = CounterFactualProto(predict_fn,
                                      shape,
                                      beta=beta,
                                      # cat_vars=cat_vars_ohe,
                                      # ohe=True,  # OHE flag
            ...
            exp1.fit(X_train, d_type='abdm', disc_perc=[25, 50, 75])
            ...
            exp2 = CounterFactualProto(predict_fn,
                                      shape,
                                      beta=beta,
                                      # cat_vars=cat_vars_ohe,
                                      # ohe=True,  # OHE flag
            ...
            exp2.fit(X_train, d_type='abdm', disc_perc=[25, 50, 75])
        ...
        explanation2 = exp2.explain(x2.reshape(1, -1))
...
def main():
    ...
    filename_stability = path_results + 'instability_%s_%s_cegp.csv' % (dataset, black_box)
