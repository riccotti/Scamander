...
def experiment(cfe, bb, X_train, variable_features, metric, continuous_features, categorical_features_lists,
               ...
               categorical_features_all, ratio_cont, nbr_features, filename_results, features_names, nbr_exp):
    ...
    for nbr_train_perc in np.arange(0.2, 1.2, 0.2):
        ...
        for id_exp in range(nbr_exp):
            ...
            exp = fatf_cf.CounterfactualExplainer(predictive_function=bb.predict, dataset=X_train_sub,
...
def main():
    ...
    filename_train_size = path_results + 'train_size_%s_%s_fat.csv' % (dataset, black_box)
    ...
    experiment('fat-bf', bb, X_train, variable_features, metric,
               ...
               filename_train_size, features_names, nbr_exp_per_train_size)
