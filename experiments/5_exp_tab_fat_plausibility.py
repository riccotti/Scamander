...
def experiment(cfe, bb, X_train, variable_features, metric, continuous_features, categorical_features_lists,
               ...
               categorical_features_all, ratio_cont, nbr_features, filename_results, features_names):
...
def main():
    ...
    filename_plusibility = path_results + 'plausibility_%s_%s_fat.csv' % (dataset, black_box)
    ...
    experiment('fat-bf', bb, X_train, variable_features, metric,
               ...
               filename_plusibility, features_names)
