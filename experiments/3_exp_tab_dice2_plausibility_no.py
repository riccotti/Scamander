...
def main():
    ...
    filename_plusibility = path_results + 'plusibility_%s_%s_dice2.csv' % (dataset, black_box)
    ...
    experiment('dice2', bb, bb_dice, d, X_train, variable_features, features_names, variable_features_names, X_test,
               ...
               nbr_features, filename_plusibility, variable_features_flag, known_train, search_diversity,
               metric, backend)
