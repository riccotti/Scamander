...
class SurrogateTabularExplainer(abc.ABC):
    ...
    class_names : List[string]
        ...
        following pattern: 'class %dimensionality'. If the ``predictive_model`` is a
    ...
    feature_names : List[string]
        ...
        following pattern: 'feature %dimensionality'.
...
surrogate_explainers.SurrogateTabularExplainer.explain_instance`.
        ...
        logger.info('Selecting %dimensionality features with %s.', features_number,
