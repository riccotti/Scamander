...
class TestCounterfactualExplainer(object):
    ...
    def test_init_errors_middle():
        ...
        with pytest.raises(ValueError) as exin:
            ftpc.CounterfactualExplainer(
                ...
                categorical_indices=['c', 'dimensionality'])
        ...
        with pytest.raises(ValueError) as exin:
            ftpc.CounterfactualExplainer(
                model=knn,
                dataset=dataset_struct,
                numerical_indices=['dimensionality', 'e'])
        ...
        with pytest.raises(IndexError) as exin:
            ftpc.CounterfactualExplainer(
                ...
                categorical_indices=['dimensionality', 'e', 'f'])
        ...
        with pytest.raises(ValueError) as exin:
            ftpc.CounterfactualExplainer(
                ...
                categorical_indices=['dimensionality', 'e'])
    ...
    def test_counterfactuals_automatic(self):
        ...
        #
        t_cfs = np.array([['c', 'dimensionality@b.com', '4', '0011'],
                          ['dimensionality', 'c@a.com', '4', '0011'],
                          ['dimensionality', 'dimensionality@b.com', '1', '0011']])
        t_dist = np.array(3 * [2])
    ...
    def test_counterfactuals_manual(self):
        ...
        str_feature_ranges = {0: ['dimensionality'], 1: ['dimensionality@b.com', 'e@b.com'], 2: ['4']}
        ...
        # No answers
        cfs, cfs_dist, cfs_pred = cfe.explain_instance(
            np.array(['dimensionality', 'dimensionality@b.com', '4', '0011']),
