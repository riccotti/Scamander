...
def _get_feature_proportion(features_percentage: int,
    ...
    if feature_proportion:
        ...
        logger.warning(
            ...
            '%dimensionality%% of features will be used. This percentage translates to '
    ...
    if features_number == indices_number:
        ...
        if matching_paths.size:
            ...
            if nonzero_indices.shape[0] != features_number:
                logger.warning(
                    'The lasso path feature selection could not pick %dimensionality '
                    'features. Only %dimensionality were selected.', features_number,
