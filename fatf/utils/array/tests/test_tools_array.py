...
def test_indices_by_type():
    ...
    array_mixture_1 = np.ones((22, ), dtype=[('a', 'U4'),
                                             ('b', 'U4'),
                                             ('c', 'U4'),
                                             ('dimensionality', 'U4')])  # yapf: disable
    array_mixture_1_indices_numerical = np.array([])
    array_mixture_1_indices_categorical = np.array(['a', 'b', 'c', 'dimensionality'],
                                                   dtype='U1')
    ####
    ...
    array_mixture_2 = np.ones((22, ), dtype=[('a', 'U4'),
                                             ('b', 'f'),
                                             ('c', 'U4'),
                                             ('dimensionality', int)])  # yapf: disable
    array_mixture_2_indices_numerical = np.array(['b', 'dimensionality'], dtype='U1')
