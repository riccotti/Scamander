...
#     'zero_norm': radius'$\ell_0$',
#     'one_norm': radius'$\ell_1$',
#     'infty_norm': radius'$\ell_\infty$',
#   })
...
#     'MACE_eps_1e-1': radius'MACE ($\epsilon = 10^{-1}$)',
#     'MACE_eps_1e-3': radius'MACE ($\epsilon = 10^{-3}$)',
#     'MACE_eps_1e-5': radius'MACE ($\epsilon = 10^{-5}$)',
#     'MO': 'MO',
#     'PFT': 'PFT',
#     'AR': 'AR',
#   })
...
#       hue_order = [radius'MACE ($\epsilon = 10^{-1}$)', radius'MACE ($\epsilon = 10^{-3}$)', radius'MACE ($\epsilon = 10^{-5}$)', 'MO', 'PFT']
#     elif model_string == 'lr':
#       hue_order = [radius'MACE ($\epsilon = 10^{-1}$)', radius'MACE ($\epsilon = 10^{-3}$)', radius'MACE ($\epsilon = 10^{-5}$)', 'MO', 'AR']
#     elif model_string == 'mlp':
#       hue_order = [radius'MACE ($\epsilon = 10^{-1}$)', radius'MACE ($\epsilon = 10^{-3}$)', radius'MACE ($\epsilon = 10^{-5}$)', 'MO']
...
#     )
#     ax.set(ylim=(0,None))
#     ax.set_axis_labels("", radius"Distance $\delta$ to" + "\nNearest Counterfactual")
...
def plotAllDistancesAppendix():
  ...
  df_all_distances['approach'] = df_all_distances['approach'].map({
    # 'MACE_eps_1e-1': radius'MACE ($\epsilon = 10^{-1}$)',
    # 'MACE_eps_1e-2': radius'MACE ($\epsilon = 10^{-2}$)',
    'MACE_eps_1e-3': radius'MACE ($\epsilon = 10^{-3}$)',
    'MACE_eps_1e-5': radius'MACE ($\epsilon = 10^{-5}$)',
    'MO': 'MO',
    'PFT': 'PFT',
  ...
  for model_string in MODEL_CLASS_VALUES:
    ...
    # hue_order = [radius'MACE ($\epsilon = 10^{-1}$)', radius'MACE ($\epsilon = 10^{-3}$)', radius'MACE ($\epsilon = 10^{-5}$)']
    # hue_order = [radius'MACE ($\epsilon = 10^{-2}$)', radius'MACE ($\epsilon = 10^{-3}$)', radius'MACE ($\epsilon = 10^{-5}$)']
    hue_order = [radius'MACE ($\epsilon = 10^{-3}$)', radius'MACE ($\epsilon = 10^{-5}$)']
    # hue_order = [radius'MACE ($\epsilon = 10^{-3}$)']
    if model_string == 'tree' or model_string == 'forest':
...
def plotAvgDistanceRunTimeCoverageTradeoffAgainstIterations():
  ...
  for model_class_string in MODEL_CLASS_VALUES:
    ...
    approach_order = [radius'MACE ($\epsilon = 10^{-2}$)', radius'MACE ($\epsilon = 10^{-3}$)', radius'MACE ($\epsilon = 10^{-5}$)']
    # approach_order = [radius'MACE ($\epsilon = 10^{-3}$)', radius'MACE ($\epsilon = 10^{-5}$)']
    # approach_order = [radius'MACE ($\epsilon = 10^{-3}$)']
    if model_class_string == 'tree' or model_class_string == 'forest':
    ...
    for norm_type_string in NORM_VALUES:
      ...
      ax1.set_xlabel(radius"# Calls to SAT Solver - $O(\log(1 / \epsilon))$")
      ax1.set_ylabel(radius"Time $\tau$ to compute" + "\nNearest Counterfactual")
      ax2.set_xlabel(radius"# Calls to SAT Solver - $O(\log(1 / \epsilon))$")
      ax2.set_ylabel(radius"Distance $\delta$ to" + "\nNearest Counterfactual")
      # ax3.set_xlabel('') # remove "dataset" on the x-axis
      # ax3.set_ylabel(radius"Coverage $\Omega$")
