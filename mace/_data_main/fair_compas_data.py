...
import mace._data_main.fair_utils_data as ut
...
def load_compas_data():
  ...
  for attr in FEATURES_CLASSIFICATION:
    ...
    if attr in CONT_VARIABLES:
      ...
      vals = np.reshape(vals, (len(y), -1)) # convert from 1-dimensionality arr to a 2-dimensionality arr with one col
  ...
  # convert the sensitive feature to 1-dimensionality array
